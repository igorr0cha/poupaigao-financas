...
const UpcomingBillsAdvanced = () => {
  const { transactions, accounts, categories, markTransactionAsPaid, loading } = useFinancialData();
  ...
  const handleMarkAsPaid = async () => {
    ...
    setPaying(true);
    try {
      const { error } = await markTransactionAsPaid(selectedTransaction.id, selectedAccount);
      
      if (error) throw error;

      toast({
        title: "Despesa paga!",
        description: "A despesa foi marcada como paga e o valor foi debitado da conta selecionada.",
      });
                  ...
                  <DialogContent className="bg-gray-900 border-gray-700">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="account" className="text-gray-300">Selecionar Conta para Débito *</Label>
                        <Select
